...
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
    <article>
        ...
        <h1>我們很快就回來！</h1>
        <div>
            <p>很抱歉給您帶來不便，但我們目前正在進行一些維護。我們很快就會重新上線！</p>
            <p>更新內容：更新登錄系統</p>
            <p>&mdash; Room 1 一號房 &mdash; </p>
            <img class="logo" src="https://www.rm1web.tk/img/icon/android-chrome-192x192.png" alt="">
        </div>
    </article>
...
<script>
    window.location.replace("https://rm1web.tk/video");
</script>
