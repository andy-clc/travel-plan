...
/* $(document).ready(function () {
	if (location.href == 'https://rm1web.tk/home' || location.href == 'https://rm1web.tk/') {
...
$(document).ready(function () {
	setTimeout(() => {
		$("body").append('<div class="alert alert-danger fade"id="outdate_alert"style="position: fixed;top: 10%;left: 50%;transform: translate(-50%,-50%);font-size:21px;font-weight:1000;text-shadow:0px 1px 1px #721c24" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">x</span></button>網站將於2023年6月28日到期，屆時網站將立即關閉，敬請知悉</div>');
		setTimeout(() => {
			$("#outdate_alert").addClass("show")
		}, 1000);
		setTimeout(() => {
			$("#outdate_alert").removeClass("show")
		}, 10000);
	}, 4000);
